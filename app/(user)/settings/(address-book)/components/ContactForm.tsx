...
export function ContactForm({
  ...
  addAddressSchema
    ...
    .refine(
      (data) => {
        const ready = `${data.readyTimeHour}:${data.readyTimeMinute}:${data.readyTimeAmPm}`;

        const close = `${data.closeTimeHour}:${data.closeTimeMinute}:${data.closeTimeAmPm}`;
  ...
  const {
    data: palletShippingLocationTypesRes,
    isLoading: isLoadingPallet,
    isPending: isPendingPallet,
  } = useQuery({
        ...
        <GlobalForm
          ...
          fields={[
            ...
            },
            {
              ...
              options: filteredProvinces?.length
                ? filteredProvinces
                : PROVINCES,
            ...
            },
            {
              ...
              options:
                palletShippingLocationTypesRes?.palletShippingLocationTypes.map(
                  (palletShipping: LocationType) => ({

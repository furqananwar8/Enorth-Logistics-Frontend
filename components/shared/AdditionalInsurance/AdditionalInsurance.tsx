...
const AdditionalInsurance = forwardRef(
  (
    {
      viewOnly,
    }: {
          ...
          <AccordionItem value="insurance" className="border-none">
            ...
            <AccordionContent className="px-6 pb-6 space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-2">
                        ...
                        >
                          <div className="flex items-center space-x-2">
                            <RadioGroupItem
                              value="CAD"
                              id="currency-cad"
                              className="text-amber-500 border-amber-500 cursor-pointer"
                            />
                            <Label
                              htmlFor="currency-cad"
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <Label
                              ...
                              className="font-normal cursor-pointer text-slate-500"
                            >
                              USD
                            </Label>
                          </div>
                ...
                <div className="space-y-3">
                  ...
                  <Controller
                    ...
                    render={({ field }) => (
                      <Select
                        value={field.value || "enorth"}
                        onValueChange={field.onChange}
                        disabled={viewOnly}

                      >
                        <SelectTrigger className="w-50 bg-white cursor-pointer">
                          <SelectValue placeholder="ENorth" />
                        </SelectTrigger>
                        <SelectContent>
                          <SelectItem className="cursor-pointer" value="enorth">
                            ENorth
                          </SelectItem>
                          <SelectItem
                            className="cursor-pointer"
              ...
              <div className="bg-blue-50/50 p-4 rounded-md flex gap-3 items-start text-sm text-slate-600 border border-blue-100">
                ...
                <p>
                  Please note that without the purchase of{" "}
                  <span className="font-semibold text-slate-800">
                    ENorth Insurance
                  </span>
                  , the carrier's liability for any loss or damage to your
                  Parcel Shipment will be limited to{" "}
                  <span className="font-semibold text-slate-800">
                    $2.00 per pound
                  </span>{" "}
                  or{" "}

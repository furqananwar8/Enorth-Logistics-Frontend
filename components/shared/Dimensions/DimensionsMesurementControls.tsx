...
export function DimensionsMeasurementControls({
  shipmentType,
  fieldCount,
  onQuantityChange,
  viewOnly,
    ...
    <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 bg-slate-50 dark:bg-card border p-4 rounded-md">
      {shipmentType !== "STANDARD_FTL" && shipmentType !== "COURIER_PAK" ? (
        <div className="flex items-center gap-4">
          <Label className="font-semibold text-slate-800 dark:text-slate-100 mb-0">
            Quantity
          </Label>
          <Select
      ...
      <div
        className={`${shipmentType === "STANDARD_FTL" || shipmentType === "COURIER_PAK" ? "w-full" : "flex-col sm:items-end space-y-3"} flex `}
      >
        <Controller
          control={control}
          ...
          disabled={viewOnly}
            ...
            >
              <div className="flex items-center space-x-2">
                ...
                <Label
                  htmlFor="metric-global"
                  className="font-normal cursor-pointer flex items-center gap-1 text-slate-500"
                >
              ...
              <div className="flex items-center space-x-2">
                ...
                />
                <Label
                  htmlFor="imperial-global"
                  className="font-semibold cursor-pointer text-slate-800 dark:text-slate-100"
                >
